...
- `docs/product/` for PRD, product strategy, and PM guides.
- `docs/architecture/` for system design and architecture.
- `docs/engineering/data-model/` for schema and migration/change specs.
- `docs/ai/` for versioned prompts, eval fixtures, and rubrics.
- `docs/governance/` for ADRs.
