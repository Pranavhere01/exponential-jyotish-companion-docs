...
Source spec: `docs/engineering/data-model/schema-v0.3-change-spec.md`
...
- Canonical schema location: `docs/engineering/data-model/schema-v0.2-base.sql`.
...
| --- | --- | --- |
| `charts` | Present | In `docs/engineering/data-model/schema-v0.2-base.sql`; stores immutable `chart_object`, `facts_sheet_text`, engine metadata, ayanamsa, house system, and lifecycle status. |
...
- Added `docs/engineering/data-model/schema-v0.3-change-spec.md` as the source-of-truth v0.3 change spec.
