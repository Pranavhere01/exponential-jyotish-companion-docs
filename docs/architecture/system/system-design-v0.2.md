...
Status: Draft v0.2  
Date: 2026-06-29  
Companion PRD: `docs/product/requirements/prd-v0.2.md`  
...
- Prompt-level behavior in `docs/ai/prompts/astrologer-persona-v0.2.md`.
- Evaluator checks in `docs/ai/prompts/prediction-evaluator-v0.2.md` and `prediction_evaluations`.
...
The initial eval baseline lives under `docs/ai/evaluation/`.
...
The schema base is `docs/engineering/data-model/schema-v0.2-base.sql`.
